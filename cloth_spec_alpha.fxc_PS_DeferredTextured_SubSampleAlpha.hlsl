...
//   float HardAlphaBlend;              // Offset:   16 Size:     4
//
// }
//
//
...
div r1.y, r1.y, r1.z
mad r0.w, -r0.w, cb2[11].x, r1.y
mad r0.w, cb12[1].x, r0.w, r1.x
dp2 r1.x, v0.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
frc r1.x, r1.x
lt r1.x, r1.x, l(0.500000)
lt r1.y, r0.w, l(1.000000)
and r1.x, r1.y, r1.x
ge r1.y, l(0.003922), r0.w
or r1.x, r1.y, r1.x
discard_nz r1.x
...
mul r2.yz, v1.xxyx, cb2[11].zzyz
mad o1.xyz, r1.yzwy, l(0.500000, 0.500000, 0.500000, 0.000000), l(0.500000, 0.500000, 0.500000, 0.000000)
mad r2.x, v1.x, cb2[11].z, cb3[45].w
mul r1.yz, r2.xxzx, l(0.000000, 0.500000, 0.500000, 0.000000)
sqrt o3.xy, r1.yzyy
mad r1.x, v3.z, r1.x, l(-0.350000)
mul_sat r1.x, r1.x, l(1.538462)
...
add_sat r0.x, cb12[0].z, l(0.400000)
