...
mad r1.xyz, r0.zzzz, cb6[2].xzyx, r1.xyzx
mad r1.xyz, r1.xyzx, cb6[7].xzyx, cb6[11].xzyx
add r2.xyz, r1.xyzx, l(0.500000, 0.000000, 3.500000, 0.000000)
max r1.x, |r1.z|, |r1.x|
add r1.x, r1.x, l(-0.450000)
mul_sat r1.x, r1.x, l(15.000000)
mul r2.w, r2.z, l(0.250000)
sample_c_lz r1.y, r2.xwxx, t15.xxxx, s15, r2.y
