...
//   float specular2Factor;             // Offset:   12 Size:     4
//   float specular2ColorIntensity;     // Offset:   16 Size:     4
//   float3 specular2Color;             // Offset:   20 Size:    12
...
rsq r0.x, r0.x
mad r0.xyz, v5.xyzx, r0.xxxx, -cb3[0].xyzx
dp3 r0.w, r0.xyzx, r0.xyzx
rsq r0.w, r0.w
mul r0.xyz, r0.wwww, r0.xyzx
max r0.w, cb12[2].x, l(0.001000)
sample r1.xyzw, v3.xyxx, t4.xyzw, s4
mad r1.xy, r1.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
mul r1.zw, r0.wwww, r1.xxxy
dp2 r0.w, r1.xyxx, r1.xyxx
add r0.w, -r0.w, l(1.000000)
sqrt r0.w, |r0.w|
mul r1.xyw, r1.wwww, v7.xyxz
mad r1.xyz, r1.zzzz, v6.xyzx, r1.xywx
mad r1.xyz, r0.wwww, v4.xyzx, r1.xyzx
dp3 r0.w, r1.xyzx, r1.xyzx
rsq r0.w, r0.w
mul r1.xyw, r0.wwww, r1.xyxz
mad r0.w, r1.z, r0.w, l(-0.350000)
...
log r0.x, r0.x
sample r1.xyzw, v3.xyxx, t5.xyzw, s5
mul r1.xyzw, r1.xyxy, r1.xyxy
mad r0.yz, r1.xxwx, cb12[0].zzwz, l(0.000000, 0.400000, 0.000000, 0.000000)
mul r1.xyz, r1.xyzx, cb12[0].zyxz
mul r0.x, r0.x, r0.z
mov_sat r0.y, r0.y
mul r2.xy, r0.yyyy, l(0.500000, 0.488281, 0.000000, 0.000000)
exp r0.x, r0.x
mul r0.y, r1.z, cb12[1].x
mul r3.xyz, r0.yyyy, cb12[1].yzwy
mul r0.xyz, r0.xxxx, r3.xyzx
sample r3.xyzw, v3.xyxx, t0.xyzw, s0
mad r0.xyz, r3.xyzx, v2.xyzx, r0.xyzx
mul r1.z, r3.w, v1.w
mul o0.w, r1.z, cb2[11].x
add r1.z, -cb2[12].z, l(1.000000)
mul r0.w, r0.w, r1.z
mul r3.yz, v1.xxyx, cb2[11].zzyz
mul r0.w, r0.w, r3.y
mad r1.z, -r1.x, l(0.500000), l(1.000000)
mul r4.yz, r1.xxyx, l(0.000000, 1.000000, 0.001953, 0.000000)
mul r1.x, r0.w, r1.z
mad r1.x, r1.x, l(-0.500000), l(1.000000)
mul o0.xyz, r0.xyzx, r1.xxxx
mad_sat o1.w, v4.z, l(128.000000), l(-127.000000)
mov r2.z, l(0.970000)
mov r4.w, cb12[0].x
add r0.xyz, r2.xyzx, -r4.yzwy
