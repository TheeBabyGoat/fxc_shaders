...
//   float reflectivePower;             // Offset:    4 Size:     4 [unused]
//   float useTessellation;             // Offset:    8 Size:     4 [unused]
//   float HardAlphaBlend;              // Offset:   12 Size:     4 [unused]
//
// }
//
// cbuffer csmshader
...
max r4.z, |r7.y|, |r7.x|
lt r4.z, r4.z, r3.w
movc r4.z, r4.z, l(2), l(3)
max r4.w, |r6.y|, |r6.x|
lt r4.w, r4.w, r3.w
movc r4.z, r4.w, l(1), r4.z
max r4.w, |r5.y|, |r5.x|
lt r3.w, r4.w, r3.w
movc r3.w, r3.w, l(0), r4.z
mov r5.xyz, x0[r3.w + 0].xyzx
itof r3.w, r3.w
add r4.z, r3.w, l(0.500000)
mul r4.z, r4.z, l(0.250000)
eq r6.xyzw, l(0.000000, 1.000000, 2.000000, 3.000000), r3.wwww
and r6.xyzw, r6.xyzw, l(0x3f800000, 0x3f800000, 0x3f800000, 0x3f800000)
dp4 r3.w, r6.xyzw, cb6[12].xyzw
dp4 r4.w, r6.xyzw, cb6[13].xyzw
add r6.x, r5.x, l(0.500000)
mad r6.y, r5.y, l(0.250000), r4.z
ne r4.z, r3.w, l(0.000000)
add r3.w, -r3.w, r5.z
...
div r5.x, l(1.000000, 1.000000, 1.000000, 1.000000), r10.x
mul r5.y, r7.z, r9.y
mad r10.z, r7.x, r9.w, -r5.y
mul r5.xy, r5.xxxx, r10.yzyy
...
mad r3.w, -r4.w, r5.y, r3.w
movc r8.z, r4.z, r3.w, r5.z
mov r6.z, l(0)
...
add r5.xyz, -v6.xyzx, cb3[3].xyzx
add r6.xyz, v6.xyzx, -cb3[3].xyzx
dp3 r5.w, r6.xyzx, cb3[11].xyzx
div_sat r5.w, r5.w, cb3[19].w
mul r5.w, r5.w, cb3[19].w
mad r6.xyz, cb3[11].xyzx, r5.wwww, cb3[3].xyzx
add r6.xyz, r6.xyzx, -v6.xyzx
...
if_nz r4.w
  ...
  mul r5.w, r5.w, r6.x
  mul r4.w, r4.w, r5.w
  mul r6.xyz, r4.wwww, cb3[20].xyzx
...
if_z r3.w
  ...
  add r6.xyz, -v6.xyzx, cb3[5].xyzx
  add r7.xyz, v6.xyzx, -cb3[5].xyzx
  dp3 r5.w, r7.xyzx, cb3[13].xyzx
  div_sat r5.w, r5.w, cb3[21].w
  mul r5.w, r5.w, cb3[21].w
  mad r7.xyz, cb3[13].xyzx, r5.wwww, cb3[5].xyzx
  add r7.xyz, r7.xyzx, -v6.xyzx
  movc r6.xyz, r4.wwww, r6.xyzx, r7.xyzx
  dp3 r4.w, r6.xyzx, r6.xyzx
  add r6.xyz, r6.xyzx, l(0.000001, 0.000001, 0.000001, 0.000000)
  ...
  mul r5.w, r5.w, r6.x
  mul r4.w, r4.w, r5.w
  mul r6.xyz, r4.wwww, cb3[21].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r3.wwww, r5.xyzx, r6.xyzx
else 
  mov r3.w, l(-1)
...
if_z r3.w
  ...
  add r6.xyz, -v6.xyzx, cb3[6].xyzx
  add r7.xyz, v6.xyzx, -cb3[6].xyzx
  dp3 r5.w, r7.xyzx, cb3[14].xyzx
  div_sat r5.w, r5.w, cb3[22].w
  mul r5.w, r5.w, cb3[22].w
  mad r7.xyz, cb3[14].xyzx, r5.wwww, cb3[6].xyzx
  add r7.xyz, r7.xyzx, -v6.xyzx
  movc r6.xyz, r4.wwww, r6.xyzx, r7.xyzx
  dp3 r4.w, r6.xyzx, r6.xyzx
  add r6.xyz, r6.xyzx, l(0.000001, 0.000001, 0.000001, 0.000000)
  ...
  mul r5.w, r5.w, r6.x
  mul r4.w, r4.w, r5.w
  mul r6.xyz, r4.wwww, cb3[22].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r3.wwww, r5.xyzx, r6.xyzx
else 
  mov r3.w, l(-1)
...
if_z r3.w
  ...
  add r6.xyz, -v6.xyzx, cb3[7].xyzx
  add r7.xyz, v6.xyzx, -cb3[7].xyzx
  dp3 r5.w, r7.xyzx, cb3[15].xyzx
  div_sat r5.w, r5.w, cb3[23].w
  mul r5.w, r5.w, cb3[23].w
  mad r7.xyz, cb3[15].xyzx, r5.wwww, cb3[7].xyzx
  add r7.xyz, r7.xyzx, -v6.xyzx
  movc r6.xyz, r4.wwww, r6.xyzx, r7.xyzx
  dp3 r4.w, r6.xyzx, r6.xyzx
  add r6.xyz, r6.xyzx, l(0.000001, 0.000001, 0.000001, 0.000000)
  ...
  mul r5.w, r5.w, r6.x
  mul r4.w, r4.w, r5.w
  mul r6.xyz, r4.wwww, cb3[23].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r3.wwww, r5.xyzx, r6.xyzx
else 
  mov r3.w, l(-1)
...
if_z r3.w
  ...
  add r6.xyz, -v6.xyzx, cb3[8].xyzx
  add r7.xyz, v6.xyzx, -cb3[8].xyzx
  dp3 r5.w, r7.xyzx, cb3[16].xyzx
  div_sat r5.w, r5.w, cb3[24].w
  mul r5.w, r5.w, cb3[24].w
  mad r7.xyz, cb3[16].xyzx, r5.wwww, cb3[8].xyzx
  add r7.xyz, r7.xyzx, -v6.xyzx
  movc r6.xyz, r4.wwww, r6.xyzx, r7.xyzx
  dp3 r4.w, r6.xyzx, r6.xyzx
  add r6.xyz, r6.xyzx, l(0.000001, 0.000001, 0.000001, 0.000000)
  ...
  mul r5.w, r5.w, r6.x
  mul r4.w, r4.w, r5.w
  mul r6.xyz, r4.wwww, cb3[24].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r3.wwww, r5.xyzx, r6.xyzx
else 
  mov r3.w, l(-1)
...
if_z r3.w
  ...
  add r6.xyz, -v6.xyzx, cb3[9].xyzx
  add r7.xyz, v6.xyzx, -cb3[9].xyzx
  dp3 r5.w, r7.xyzx, cb3[17].xyzx
  div_sat r5.w, r5.w, cb3[25].w
  mul r5.w, r5.w, cb3[25].w
  mad r7.xyz, cb3[17].xyzx, r5.wwww, cb3[9].xyzx
  add r7.xyz, r7.xyzx, -v6.xyzx
  movc r6.xyz, r4.wwww, r6.xyzx, r7.xyzx
  dp3 r4.w, r6.xyzx, r6.xyzx
  add r6.xyz, r6.xyzx, l(0.000001, 0.000001, 0.000001, 0.000000)
  ...
  mul r5.w, r5.w, r6.x
  mul r4.w, r4.w, r5.w
  mul r6.xyz, r4.wwww, cb3[25].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r3.wwww, r5.xyzx, r6.xyzx
else 
  mov r3.w, l(-1)
...
if_z r3.w
  ...
  add r6.xyz, -v6.xyzx, cb3[10].xyzx
  add r7.xyz, v6.xyzx, -cb3[10].xyzx
  ...
  mul r5.w, r5.w, r6.x
  mul r4.w, r4.w, r5.w
  mul r6.xyz, r4.wwww, cb3[26].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r3.wwww, r5.xyzx, r6.xyzx
endif 
...
mad r6.xyz, cb3[45].xyzx, r1.zzzz, cb3[46].xyzx
...
mad r1.xyz, r1.yzwy, r1.xxxx, r5.xyzx
