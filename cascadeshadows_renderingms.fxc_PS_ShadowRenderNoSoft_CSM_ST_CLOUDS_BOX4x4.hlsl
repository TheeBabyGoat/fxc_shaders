...
mad r4.xyz, r2.xyzx, cb6[6].xyzx, cb6[10].xyzx
mov x0[2].xyz, r4.xyzx
mad r2.xyz, r2.xyzx, cb6[7].xyzx, cb6[11].xyzx
mov x0[3].xyz, r2.xyzx
mul r5.yz, cb6[14].zzwz, l(0.000000, -1.000000, -0.250000, 0.000000)
...
mad r3.y, r1.z, l(0.250000), r2.z
ne r1.y, r1.x, l(0.000000)
add r1.x, -r1.x, r1.w
deriv_rtx r4.xyw, r3.xyxy
deriv_rtx r4.z, r1.x
deriv_rty r6.xyz, r3.yxyy
deriv_rty r6.w, r1.x
mul r4.yw, r4.yyyw, r6.yyyw
mad r7.xy, r4.xzxx, r6.xzxx, -r4.ywyy
div r1.z, l(1.000000, 1.000000, 1.000000, 1.000000), r7.x
mul r2.z, r4.z, r6.y
mad r7.z, r4.x, r6.w, -r2.z
mul r4.xy, r1.zzzz, r7.yzyy
max r4.xy, r4.xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
min r4.xy, r4.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mad r1.x, -r2.w, r4.x, r1.x
mad r1.x, -r2.w, r4.y, r1.x
movc r3.z, r1.y, r1.x, r1.w
mov r5.w, l(0)
add r1.xyz, r3.xyzx, r5.yzwy
...
sample_c_lz r4.y, r3.xyxx, t15.xxxx, s15, r3.z
...
mul r5.xy, cb6[14].zwzz, l(-1.000000, 0.250000, 0.000000, 0.000000)
mov r5.z, l(0)
add r5.xyz, r3.xyzx, r5.xyzx
sample_c_lz r5.x, r5.xyxx, t15.xxxx, s15, r5.z
mul r6.xy, cb6[14].zwzz, l(0.000000, 0.250000, 0.000000, 0.000000)
mov r6.z, l(0)
add r6.xyz, r3.xyzx, r6.xyzx
sample_c_lz r5.y, r6.xyxx, t15.xxxx, s15, r6.z
mul r6.xy, cb6[14].zwzz, l(1.000000, 0.250000, 0.000000, 0.000000)
mov r6.z, l(0)
add r6.xyz, r3.xyzx, r6.xyzx
sample_c_lz r5.z, r6.xyxx, t15.xxxx, s15, r6.z
