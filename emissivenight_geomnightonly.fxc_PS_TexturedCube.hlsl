...
mad r0.w, v3.z, r0.w, cb3[43].w
mul r0.w, r0.w, cb3[44].w
max r0.w, r0.w, l(0.000000)
dp3_sat r0.x, r0.xyzx, r1.xyzx
dp3_sat r0.y, r1.xyzx, -cb3[0].xyzx
mad r1.xyz, cb3[43].xyzx, r0.wwww, cb3[44].xyzx
mad r1.xyz, cb3[49].xyzx, r0.xxxx, r1.xyzx
mad r2.xyz, cb3[45].xyzx, r0.wwww, cb3[46].xyzx
mad r0.xzw, cb3[47].xxyz, r0.wwww, cb3[48].xxyz
mul r2.xyz, r2.xyzx, cb2[12].zzzz
add r1.w, -cb2[12].z, l(1.000000)
mad r0.xzw, r0.xxzw, r1.wwww, r2.xxyz
mov_sat r2.xyzw, v1.xyzw
mul r2.xy, r2.xyxx, cb2[11].zyzz
mul r2.xy, r2.xyxx, r2.xyxx
mul r0.xzw, r0.xxzw, r2.yyyy
mad r0.xzw, r1.xxyz, r2.xxxx, r0.xxzw
...
mul r0.y, r2.x, r2.x
mul r0.y, r0.y, cb3[0].w
mul r4.xyz, r0.yyyy, cb3[1].xyzx
mul r3.xyz, r3.xyzx, r4.xyzx
mad r0.xyz, r3.xyzx, r2.xxxx, r0.xzwx
mul r0.w, cb2[11].w, cb12[0].x
mul r0.w, r0.w, r2.y
mul r0.w, r0.w, cb3[59].w
add r2.xyz, -v4.xyzx, cb1[15].xyzx
dp3 r1.w, r2.xyzx, r2.xyzx
rsq r1.w, r1.w
mul r2.zw, r1.wwww, r2.xxxy
dp2 r1.w, r2.xyxx, r2.xyxx
add r1.w, r1.w, l(-100.000000)
mul_sat r1.w, r1.w, l(0.000100)
dp2_sat r2.x, cb3[59].xyxx, r2.zwzz
add r1.w, r1.w, r2.x
