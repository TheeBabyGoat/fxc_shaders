...
sample r3.xyzw, v0.zwzz, t14.xyzw, s14
add r4.xyz, -r3.xyzx, v1.xyzx
mad_sat r3.xyz, v1.wwww, r4.xyzx, r3.xyzx
...
sample r2.xyzw, v0.xyxx, t8.xyzw, s8
mul r1.w, r3.y, r4.x
mul r2.w, r3.z, r1.w
mul r1.w, r4.z, r1.w
...
mul r3.xy, v4.xyxx, cb2[11].zyzz
mul r3.xy, r3.xyxx, r3.xyxx
mul r2.xyz, r2.xyzx, r3.yyyy
mov r5.x, cb3[46].w
mov r5.y, cb3[47].w
mov r5.z, cb3[48].w
dp3_sat r1.w, r5.xyzx, v3.xyzx
