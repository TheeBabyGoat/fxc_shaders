...
mul r1.yz, r4.xxzx, l(0.000000, 0.500000, 0.500000, 0.000000)
sqrt o3.xy, r1.yzyy
mul_sat o3.z, r2.y, l(0.062500)
mad r0.w, v3.z, r1.x, l(-0.350000)
mul_sat r0.w, r0.w, l(1.538462)
mul r0.w, r0.w, cb5[3].z
add r1.x, -cb2[12].z, l(1.000000)
mul r0.w, r0.w, r1.x
mul r0.w, r4.y, r0.w
mad r1.x, -r3.y, l(0.500000), l(1.000000)
mul r1.x, r0.w, r1.x
mad r1.x, r1.x, l(-0.500000), l(1.000000)
mul o0.xyz, r0.xyzx, r1.xxxx
mad_sat r0.x, r2.x, cb12[0].w, l(0.400000)
