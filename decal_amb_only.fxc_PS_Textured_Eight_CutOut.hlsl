...
if_z r2.w
  ...
  rsq r4.w, r4.w
  mul r6.xyz, r4.wwww, r6.xyzx
  mad_sat r3.w, -r3.w, cb3[7].w, l(1.000000)
  add r4.w, -cb3[15].w, l(1.000000)
  ...
  mul r4.w, r4.w, r5.w
  mul r3.w, r3.w, r4.w
  mul r6.xyz, r3.wwww, cb3[23].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r2.wwww, r5.xyzx, r6.xyzx
else 
  mov r2.w, l(-1)
...
if_z r2.w
  ...
  rsq r4.w, r4.w
  mul r6.xyz, r4.wwww, r6.xyzx
  mad_sat r3.w, -r3.w, cb3[8].w, l(1.000000)
  add r4.w, -cb3[16].w, l(1.000000)
  ...
  mul r4.w, r4.w, r5.w
  mul r3.w, r3.w, r4.w
  mul r6.xyz, r3.wwww, cb3[24].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r2.wwww, r5.xyzx, r6.xyzx
else 
  mov r2.w, l(-1)
...
if_z r2.w
  ...
  rsq r4.w, r4.w
  mul r6.xyz, r4.wwww, r6.xyzx
  mad_sat r3.w, -r3.w, cb3[9].w, l(1.000000)
  add r4.w, -cb3[17].w, l(1.000000)
  ...
  mul r4.w, r4.w, r5.w
  mul r3.w, r3.w, r4.w
  mul r6.xyz, r3.wwww, cb3[25].xyzx
  mad r6.xyz, r6.xyzx, r0.xyzx, r5.xyzx
  movc r5.xyz, r2.wwww, r5.xyzx, r6.xyzx
else 
  mov r2.w, l(-1)
