...
mul r0.yw, r0.zzzz, r0.xxxy
mad r0.x, -r0.x, r0.z, l(1.000000)
mul r0.x, r0.x, r0.w
mad r0.x, r0.x, l(0.300000), r0.y
add r0.x, -r0.x, l(1.000000)
dp3 r0.z, r2.xyzx, -cb12[12].xyzx
dp3 r1.w, r2.xyzx, cb12[24].yzwy
add r1.w, -r1.w, l(1.000000)
ge r1.w, r1.w, l(0.000545)
and r1.w, r1.w, l(0x3f800000)
mad r2.x, -cb12[11].x, r0.z, cb12[11].y
mad r0.z, r0.z, r0.z, l(1.000000)
log r2.x, |r2.x|
mul r2.x, r2.x, l(1.500000)
exp r2.x, r2.x
div r0.z, r0.z, r2.x
mul r2.x, r0.z, cb12[11].z
mad_sat r0.z, -r0.z, cb12[11].z, l(1.000000)
mov_sat r2.x, r2.x
mul r2.xyz, r2.xxxx, cb12[9].xyzx
...
add r0.y, r0.w, r0.y
add_sat o0.w, -r0.y, v2.w
sample r2.xyzw, v6.xyxx, t5.xyzw, s5
mad_sat r0.yzw, r2.xxyz, l(0.000000, 2.000000, 2.000000, 2.000000), l(0.000000, -0.100000, -0.100000, -0.100000)
mul r0.yzw, r0.yyzw, cb12[24].xxxx
