...
sample r1.xyz, r1.xyxx, t14.xyzw, s14
mul r1.z, r1.z, cb12[0].w
mad r3.xyzw, r1.xyyx, l(2.000000, 2.000000, 2.000000, 2.000000), l(-1.000000, -1.000000, -1.000000, -1.000000)
mad r1.xyw, r2.xyxz, cb6[4].xyxz, cb6[8].xyxz
...
mul r2.zw, cb6[14].zzzw, l(0.000000, 0.000000, 1.400000, 0.350000)
...
eq r4.xyzw, l(0.000000, 1.000000, 2.000000, 3.000000), r1.xxxx
...
add r5.x, r1.y, l(0.500000)
mad r5.y, r1.z, l(0.250000), r2.x
...
deriv_rty r7.w, r1.x
mul r4.yz, r6.yywy, r7.yywy
mad r8.xy, r6.xzxx, r7.xzxx, -r4.yzyy
div r1.z, l(1.000000, 1.000000, 1.000000, 1.000000), r8.x
mul r2.x, r6.z, r7.y
mad r8.z, r6.x, r7.w, -r2.x
mul r4.yz, r1.zzzz, r8.yyzy
max r4.yz, r4.yyzy, l(0.000000, 0.000000, 0.000000, 0.000000)
min r4.yz, r4.yyzy, l(0.000000, 0.500000, 0.500000, 0.000000)
mad r1.x, -r4.x, r4.y, r1.x
mad r1.x, -r4.x, r4.z, r1.x
movc r1.z, r1.y, r1.x, r1.w
mul r3.zw, r3.zzzw, r2.zzzw
mad r1.xy, r2.zwzz, r3.xyxx, r5.xyxx
mul r4.xy, cb6[14].zwzz, l(1.000000, 0.250000, 0.000000, 0.000000)
mov r4.z, l(0)
add r2.xzw, r1.xxyz, r4.xxyz
sample_c_lz r1.w, r2.xzxx, t15.xxxx, s15, r2.w
mad r1.xy, r3.zwzz, l(-0.500000, 0.500000, 0.000000, 0.000000), r5.xyxx
...
if_nz r1.z
  sample r1.z, r5.xyxx, t2.xywz, s2
