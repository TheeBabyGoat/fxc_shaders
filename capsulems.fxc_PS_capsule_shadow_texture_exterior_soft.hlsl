...
mul r5.xyw, r0.wwww, l(0.998047, 7.984375, 0.000000, 63.875000)
frc r5.xyw, r5.xyxw
mad r5.xy, -r5.ywyy, l(0.125000, 0.125000, 0.000000, 0.000000), r5.xyxx
mad r0.xyz, r0.xyzx, l(256.000000, 256.000000, 256.000000, 0.000000), r5.xywx
add r0.xyz, r0.xyzx, l(-128.000000, -128.000000, -128.000000, 0.000000)
dp3 r0.w, r0.xyzx, r0.xyzx
rsq r0.w, r0.w
mul r0.xyz, r0.wwww, r0.xyzx
min r0.w, r1.z, l(1.000000)
mad r1.z, r1.w, l(512.000000), l(-500.000000)
max r1.z, r1.z, l(0.000000)
mad r1.w, r1.w, l(512.000000), -r1.z
...
dp3_sat r1.y, r0.xyzx, r5.xywx
dp3_sat r2.x, -r2.xyzx, r0.xyzx
dp3_sat r2.y, r3.xyzx, r5.xywx
...
mad r2.xy, r5.zzzz, r2.xyxx, r1.wwww
add r1.zw, r1.zzzz, l(0.000000, 0.000000, 2.000000, 0.000000)
...
mad r0.xyz, r4.xyzx, r0.yyyy, r0.xxxx
