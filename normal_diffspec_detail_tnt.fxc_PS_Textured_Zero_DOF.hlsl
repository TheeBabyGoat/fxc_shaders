...
mul r3.xyz, r1.yyyy, v6.xyzx
mad r1.xyw, r1.xxxx, v5.xyxz, r3.xyxz
...
deriv_rtx r10.z, r2.z
deriv_rty r12.xyz, r9.yxyy
deriv_rty r12.w, r2.z
...
mad r2.z, -r3.w, r7.z, r2.z
mad r2.z, -r3.w, r7.w, r2.z
movc r11.z, r2.w, r2.z, r8.z
mov r9.z, l(0)
...
dp4 r2.z, r8.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
mad_sat r0.z, r0.z, cb6[0].w, cb6[1].w
max r2.w, |r7.y|, |r7.x|
mad_sat r2.w, r2.w, l(15.000000), l(-6.300000)
add r0.z, -r0.z, l(1.000000)
mul r0.z, r2.w, r0.z
mad r0.z, r2.z, l(0.062500), r0.z
mul r0.z, r0.z, r0.z
min r0.z, r0.z, l(1.000000)
mad_sat r2.z, v7.z, cb6[3].x, cb6[3].y
sqrt r2.z, r2.z
mul r2.z, r2.z, cb6[3].z
mad r0.z, r2.z, -r0.z, r0.z
dp3_sat r2.z, r3.xyzx, -cb3[0].xyzx
dp3_sat r7.x, r5.xyzx, r3.xyzx
dp3_sat r7.y, r6.xyzx, -cb3[0].xyzx
add r6.xy, -r7.xyxx, l(1.000000, 1.000000, 0.000000, 0.000000)
mul r6.zw, r6.xxxy, r6.xxxy
mul r6.zw, r6.zzzw, r6.zzzw
mul r6.xy, r6.xyxx, r6.zwzz
add r2.w, -cb12[0].x, l(1.000000)
mad r6.xy, cb12[0].xxxx, r6.xyxx, r2.wwww
mul r2.w, r0.x, r6.y
mad r0.x, -r0.x, r6.x, l(1.000000)
mul r2.w, r2.z, r2.w
mul r2.w, r2.w, l(0.250000)
mul r2.z, r0.x, r2.z
mad r6.xyz, r1.xyzx, r2.zzzz, r2.wwww
mul r6.xyz, r6.xyzx, cb3[1].xyzx
mad r0.w, r1.w, r0.w, cb3[43].w
