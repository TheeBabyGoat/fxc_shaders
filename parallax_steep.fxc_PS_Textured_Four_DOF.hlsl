...
rsq r0.z, r0.z
mul r1.xy, r0.zzzz, v6.xyxx
mul r1.xy, -r1.xyxx, cb12[0].xxxx
mov r1.zw, v1.xxxy
mov r2.x, l(1.000000)
mov r2.yzw, r0.xxyw
mov r0.z, l(0)
loop 
  ige r3.x, r0.z, l(8)
  breakc_nz r3.x
  mad r3.xy, r1.xyxx, l(0.125000, 0.125000, 0.000000, 0.000000), r1.zwzz
  sample r4.xyzw, r3.xyxx, t2.zxyw, s2
  lt r3.z, r2.w, r2.x
  add r4.x, r2.x, l(-0.125000)
  movc r1.zw, r3.zzzz, r3.xxxy, r1.zzzw
  movc r2.xyzw, r3.zzzz, r4.xyzw, r2.xyzw
  iadd r0.z, r0.z, l(1)
endloop 
...
mul r2.xy, r1.xxxx, v0.xyxx
mul_sat r1.x, r1.x, cb12[0].w
mul r0.w, r0.w, v0.w
mul r2.xy, r2.xyxx, cb2[11].zyzz
...
add r2.z, cb12[0].z, l(-500.000000)
max r2.z, r2.z, l(0.000000)
add r2.w, -r2.z, cb12[0].z
...
add r8.zw, r2.zzzz, l(0.000000, 0.000000, 2.000000, 0.000000)
mul r2.z, r8.z, l(0.125000)
...
if_z r3.w
  ...
  mul r9.w, r9.w, r10.x
  mad r9.w, cb12[0].y, r9.w, r4.w
  dp3_sat r8.x, r8.xyzx, r3.xyzx
  log r8.x, r8.x
  mul r8.x, r8.x, r8.w
  exp r8.x, r8.x
  mul r8.x, r8.x, r9.w
...
if_nz r6.w
  ...
  if_z r3.w
    ...
    mul r9.w, r9.w, r10.w
    mad r9.w, cb12[0].y, r9.w, r4.w
    dp3_sat r10.x, r10.xyzx, r3.xyzx
    log r10.x, r10.x
...
mad r1.yzw, r1.yyzw, r2.zzzz, r5.xxyz
mul r1.yzw, r2.yyyy, r1.yyzw
mad r2.yzw, cb3[43].xxyz, r1.xxxx, cb3[44].xxyz
mov r5.x, cb3[46].w
mov r5.y, cb3[47].w
mov r5.z, cb3[48].w
dp3_sat r1.x, r5.xyzx, r3.xyzx
mad r2.yzw, cb3[49].xxyz, r1.xxxx, r2.yyzw
mad r1.xyz, r2.yzwy, r2.xxxx, r1.yzwy
