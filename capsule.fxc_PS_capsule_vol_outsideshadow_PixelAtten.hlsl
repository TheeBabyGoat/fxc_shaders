...
dcl_output o0.xyzw
dcl_temps 5
round_ni r0.xy, v0.yxyy
mul r0.xy, r0.xyxx, l(0.333333, 0.333333, 0.000000, 0.000000)
frc r0.xy, r0.xyxx
mul r0.xy, r0.xyxx, l(3.000000, 9.000000, 0.000000, 0.000000)
add r0.x, r0.x, r0.y
add r0.y, cb12[17].w, l(1.000000)
div r0.zw, v2.xxxy, v2.wwww
sample r1.xyzw, r0.zwzz, t4.xyzw, s4
mad r2.xy, r0.zwzz, l(2.000000, -2.000000, 0.000000, 0.000000), l(-1.000000, 1.000000, 0.000000, 0.000000)
add r0.y, r0.y, -r1.x
div r0.y, cb12[17].z, r0.y
mov r2.z, l(1.000000)
dp3 r1.x, r2.xyzx, cb12[18].xyzx
dp3 r1.y, r2.xyzx, cb12[19].xyzx
dp3 r1.z, r2.xyzx, cb12[20].xyzx
mad r2.xyz, r1.xyzx, r0.yyyy, cb1[15].xyzx
mul r0.yzw, r0.yyyy, r1.xxyz
dp3 r0.y, r0.yzwy, r0.yzwy
add r1.xyz, v1.xyzx, -cb1[15].xyzx
mad r3.xyz, r1.xyzx, v3.yyyy, cb1[15].xyzx
mul r4.xyz, r1.xyzx, v3.yyyy
mad r1.xyz, r1.xyzx, v3.xxxx, cb1[15].xyzx
...
mad r1.xyz, r3.xyzx, l(0.014085, 0.014085, 0.014085, 0.000000), r1.xyzx
add r3.xyz, r1.xyzx, -cb1[15].xyzx
add r4.xyz, r3.xyzx, cb6[18].xyzx
dp3 r0.x, r3.xyzx, r3.xyzx
ge r0.x, r0.y, r0.x
dp3 r3.x, r4.xyzx, cb6[15].xyzx
dp3 r3.y, r4.xyzx, cb6[16].xyzx
dp3 r3.z, r4.xyzx, cb6[17].xyzx
mov r3.xyz, -r3.xyzx
dp3 r0.w, r3.xyzx, r3.xyzx
sqrt r0.w, r0.w
mul r0.w, r0.w, cb6[17].w
sample_c_lz r0.w, r3.xyzx, t14.xxxx, s14, r0.w
add r3.xyz, -r1.xyzx, cb12[0].xyzx
mad r1.xyz, r2.xyzx, l(0.126761, 0.126761, 0.126761, 0.000000), r1.xyzx
dp3 r1.w, r3.xyzx, r3.xyzx
mad_sat r1.w, -r1.w, cb12[4].z, l(1.000000)
add r2.w, -cb12[7].x, l(1.000000)
mad r3.x, r2.w, r1.w, cb12[7].x
div r1.w, r1.w, r3.x
mul r0.w, r0.w, r1.w
and r0.x, r0.w, r0.x
add r3.xyz, r1.xyzx, -cb1[15].xyzx
...
sample_c_lz r1.w, r3.xyzx, t14.xxxx, s14, r1.w
add r3.xyz, -r1.xyzx, cb12[0].xyzx
mad r1.xyz, r2.xyzx, l(0.126761, 0.126761, 0.126761, 0.000000), r1.xyzx
dp3 r3.x, r3.xyzx, r3.xyzx
mad_sat r3.x, -r3.x, cb12[4].z, l(1.000000)
mad r3.y, r2.w, r3.x, cb12[7].x
div r3.x, r3.x, r3.y
mul r1.w, r1.w, r3.x
and r0.w, r0.w, r1.w
add r0.x, r0.w, r0.x
...
add r3.xyz, -r1.xyzx, cb12[0].xyzx
mad r1.xyz, r2.xyzx, l(0.126761, 0.126761, 0.126761, 0.000000), r1.xyzx
mad r2.xyz, r2.xyzx, l(0.126761, 0.126761, 0.126761, 0.000000), r1.xyzx
dp3 r3.x, r3.xyzx, r3.xyzx
mad_sat r3.x, -r3.x, cb12[4].z, l(1.000000)
mad r3.y, r2.w, r3.x, cb12[7].x
div r3.x, r3.x, r3.y
...
mad r1.w, r2.w, r0.w, cb12[7].x
div r0.w, r0.w, r1.w
add r3.xyz, r1.xyzx, cb6[18].xyzx
...
sqrt r3.x, r3.x
mul r3.x, r3.x, cb6[17].w
sample_c_lz r1.y, r1.yzwy, t14.xxxx, s14, r3.x
mul r0.w, r0.w, r1.y
and r0.w, r0.w, r1.x
add r0.x, r0.w, r0.x
add r1.xyz, -r2.xyzx, cb12[0].xyzx
add r2.xyz, r2.xyzx, -cb1[15].xyzx
dp3 r0.w, r1.xyzx, r1.xyzx
mad_sat r0.w, -r0.w, cb12[4].z, l(1.000000)
mad r1.x, r2.w, r0.w, cb12[7].x
div r0.w, r0.w, r1.x
add r1.xyz, r2.xyzx, cb6[18].xyzx
dp3 r1.w, r2.xyzx, r2.xyzx
ge r0.y, r0.y, r1.w
dp3 r2.x, r1.xyzx, cb6[15].xyzx
dp3 r2.y, r1.xyzx, cb6[16].xyzx
dp3 r2.z, r1.xyzx, cb6[17].xyzx
mov r1.xyz, -r2.xyzx
