...
eq r6.xyzw, l(0.000000, 1.000000, 2.000000, 3.000000), r2.zzzz
and r6.xyzw, r6.xyzw, l(0x3f800000, 0x3f800000, 0x3f800000, 0x3f800000)
dp4 r2.z, r6.xyzw, cb6[12].xyzw
dp4 r3.w, r6.xyzw, cb6[13].xyzw
add r4.z, r5.x, l(0.500000)
mad r2.w, r5.y, l(0.250000), r2.w
ne r4.w, r2.z, l(0.000000)
add r2.z, -r2.z, r5.z
deriv_rtx r6.x, r4.z
deriv_rtx r5.xy, r2.wwww
deriv_rtx r6.z, r2.z
deriv_rty r7.y, r4.z
deriv_rty r7.xzw, r2.wwwz
mul r5.xy, r5.xyxx, r7.ywyy
mad r8.xy, r6.xzxx, r7.xzxx, -r5.xyxx
div r5.x, l(1.000000, 1.000000, 1.000000, 1.000000), r8.x
mul r5.y, r6.z, r7.y
mad r8.z, r6.x, r7.w, -r5.y
mul r5.xy, r5.xxxx, r8.yzyy
max r5.xy, r5.xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
min r5.xy, r5.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mad r2.z, -r3.w, r5.x, r2.z
mad r2.z, -r3.w, r5.y, r2.z
movc r2.z, r4.w, r2.z, r5.z
add r5.x, r4.z, cb6[14].z
mad r5.y, cb6[14].w, l(0.250000), r2.w
sample_c_lz r2.z, r5.xyxx, t15.xxxx, s15, r2.z
mad_sat r1.w, r1.w, cb6[0].w, cb6[1].w
max r2.w, |r4.y|, |r4.x|
mad_sat r2.w, r2.w, l(15.000000), l(-6.300000)
add r1.w, -r1.w, l(1.000000)
mad r1.w, r1.w, r2.w, r2.z
mul r1.w, r1.w, r1.w
min r1.w, r1.w, l(1.000000)
mad_sat r2.z, v3.z, cb6[3].x, cb6[3].y
sqrt r2.z, r2.z
mul r2.z, r2.z, cb6[3].z
mad r1.w, r2.z, -r1.w, r1.w
dp3_sat r2.z, r1.xyzx, -cb3[0].xyzx
mul r4.xyz, r0.xyzx, r2.zzzz
mul r4.xyz, r4.xyzx, cb3[1].xyzx
mad r0.w, v2.z, r0.w, cb3[43].w
