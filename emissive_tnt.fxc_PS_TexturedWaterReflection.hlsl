...
mad r4.z, r5.y, l(0.250000), r4.z
ne r5.y, r3.w, l(0.000000)
add r3.w, -r3.w, r5.z
deriv_rtx r6.x, r5.x
deriv_rtx r6.yw, r4.zzzz
deriv_rtx r6.z, r3.w
deriv_rty r7.y, r5.x
deriv_rty r7.xz, r4.zzzz
deriv_rty r7.w, r3.w
mul r6.yw, r6.yyyw, r7.yyyw
mad r8.xy, r6.xzxx, r7.xzxx, -r6.ywyy
div r5.w, l(1.000000, 1.000000, 1.000000, 1.000000), r8.x
mul r6.y, r6.z, r7.y
mad r8.z, r6.x, r7.w, -r6.y
mul r6.xy, r5.wwww, r8.yzyy
max r6.xy, r6.xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
min r6.xy, r6.xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
mad r3.w, -r4.w, r6.x, r3.w
mad r3.w, -r4.w, r6.y, r3.w
movc r3.w, r5.y, r3.w, r5.z
add r5.x, r5.x, cb6[14].z
mad r5.y, cb6[14].w, l(0.250000), r4.z
sample_c_lz r3.w, r5.xyxx, t15.xxxx, s15, r3.w
mad_sat r2.w, r2.w, cb6[0].w, cb6[1].w
max r4.x, |r4.y|, |r4.x|
mad_sat r4.x, r4.x, l(15.000000), l(-6.300000)
add r2.w, -r2.w, l(1.000000)
mad r2.w, r2.w, r4.x, r3.w
