...
mad_sat r3.w, -r1.x, cb12[4].z, l(1.000000)
...
mul r4.xzw, r0.wwww, l(0.998047, 0.000000, 7.984375, 63.875000)
frc r4.xzw, r4.xxzw
mad r4.xz, -r4.zzwz, l(0.125000, 0.000000, 0.125000, 0.000000), r4.xxzx
mad r0.xyz, r0.xyzx, l(256.000000, 256.000000, 256.000000, 0.000000), r4.xzwx
add r0.xyz, r0.xyzx, l(-128.000000, -128.000000, -128.000000, 0.000000)
dp3 r0.w, r0.xyzx, r0.xyzx
rsq r0.w, r0.w
mul r0.xyz, r0.wwww, r0.xyzx
min r0.w, r3.w, l(1.000000)
rsq r1.x, r1.x
mul r3.xyz, r1.xxxx, r3.xyzx
dp3 r1.x, r1.yzwy, r1.yzwy
rsq r1.x, r1.x
mul r1.xyz, r1.xxxx, r1.yzwy
mul r4.xzw, -cb12[1].zzxy, cb12[2].yyzx
mad r4.xzw, -cb12[1].yyzx, cb12[2].zzxy, -r4.xxzw
dp3 r5.x, r4.xzwx, -r3.xyzx
dp3 r5.y, cb12[2].xyzx, -r3.xyzx
dp3 r1.w, -cb12[1].xyzx, -r3.xyzx
...
mul r4.xz, r1.wwww, r5.xxyx
mad r4.xz, r4.xxzx, l(0.500000, 0.000000, 0.500000, 0.000000), l(0.500000, 0.000000, 0.500000, 0.000000)
sample_l r4.xzw, r4.xzxx, t2.xwyz, s2, l(0.000000)
mad r4.xzw, r4.xxzw, r4.xxzw, l(-1.000000, 0.000000, -1.000000, -1.000000)
mad r4.xzw, cb12[11].yyyy, r4.xxzw, l(1.000000, 0.000000, 1.000000, 1.000000)
mul r4.xzw, r4.xxzw, cb12[3].xxyz
mul r4.xzw, r4.xxzw, cb12[3].wwww
