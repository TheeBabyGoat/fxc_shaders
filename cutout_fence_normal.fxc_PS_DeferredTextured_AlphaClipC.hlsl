...
mul r1.xy, r3.xzxx, l(0.500000, 0.500000, 0.000000, 0.000000)
sqrt o3.xy, r1.xyxx
...
mul r0.w, r0.w, r1.x
mul r0.w, r3.y, r0.w
mul r1.x, cb12[0].y, l(0.001953)
mov r1.z, -r1.x
mad r2.x, -cb12[0].z, l(0.500000), l(1.000000)
mul r2.x, r0.w, r2.x
...
mov r1.yw, -cb12[0].zzzx
mov r0.z, l(0.970000)
add r0.xyz, r0.xyzx, r1.yzwy
max r0.xyz, r0.xyzx, l(0.000000, 0.000000, 0.000000, 0.000000)
mad r2.xz, r0.xxzx, r0.wwww, cb12[0].zzxz
mad r2.y, r0.y, r0.w, r1.x
sqrt o2.xy, r2.xyxx
mov o2.z, r2.z
mov o2.w, l(1.000000)
