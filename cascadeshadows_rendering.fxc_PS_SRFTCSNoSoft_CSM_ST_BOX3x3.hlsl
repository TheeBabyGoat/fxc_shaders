...
mul r1.x, r1.z, cb12[0].w
mad r1.yzw, r0.yyzw, cb6[4].xxyz, cb6[8].xxyz
mov x0[0].xyz, r1.yzwy
mad r2.xyz, r0.yzwy, cb6[5].xyzx, cb6[9].xyzx
mov x0[1].xyz, r2.xyzx
mad r0.yzw, r0.yyzw, cb6[6].xxyz, cb6[10].xxyz
mov x0[2].xyz, r0.yzwy
mov x0[3].xyz, r0.yzwy
mul r3.yz, cb6[14].zzwz, l(0.000000, -0.500000, -0.125000, 0.000000)
mad r0.w, -cb6[14].z, l(1.500000), l(1.000000)
mad r0.w, r0.w, l(0.500000), -r1.x
max r0.yz, |r0.zzzz|, |r0.yyyy|
lt r0.y, r0.y, r0.w
...
mad r0.y, -r1.w, r1.y, r0.y
movc r2.z, r0.w, r0.y, r1.z
mov r3.w, l(0)
add r1.xyz, r2.xyzx, r3.yzwy
sample_c_lz r1.x, r1.xyxx, t15.xxxx, s15, r1.z
mul r3.xy, cb6[14].zwzz, l(0.500000, -0.125000, 0.000000, 0.000000)
mov r3.z, l(0)
...
mov r3.z, l(0)
add r3.xyz, r2.xyzx, r3.xyzx
sample_c_lz r1.z, r3.xyxx, t15.xxxx, s15, r3.z
mul r3.xy, cb6[14].zwzz, l(0.500000, 0.125000, 0.000000, 0.000000)
mov r3.z, l(0)
add r3.xyz, r2.xyzx, r3.xyzx
sample_c_lz r1.w, r3.xyxx, t15.xxxx, s15, r3.z
...
mad_sat r0.y, r0.z, l(15.000000), l(-6.000000)
