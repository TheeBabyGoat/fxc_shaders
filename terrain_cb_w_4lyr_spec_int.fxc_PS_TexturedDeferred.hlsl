...
sample r1.xyzw, v1.xyxx, t6.xyzw, s6
mul r0.w, r2.y, r3.x
mul r1.w, r2.z, r0.w
mul r0.w, r3.z, r0.w
...
sample r1.xyzw, v1.xyxx, t7.xyzw, s7
...
mul r1.z, r0.w, v2.z
mul r0.w, r4.z, r0.w
mul r2.zw, r1.zzzz, r3.xxxy
mul r1.z, r1.z, cb12[1].y
mad r1.z, cb12[1].x, r0.w, r1.z
mad r2.xy, r2.xyxx, r0.wwww, r2.zwzz
mul r0.w, r4.x, v2.y
mul r1.w, r4.z, r0.w
mul r0.w, r0.w, v2.z
mad r1.xy, r1.xyxx, r1.wwww, r2.xyxx
mad r1.z, cb12[1].z, r1.w, r1.z
mad r1.z, cb12[1].w, r0.w, r1.z
sample r2.xyzw, v1.xyxx, t9.xyzw, s9
mad r1.xy, r2.xyxx, r0.wwww, r1.xyxx
mad r1.xy, r1.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000), l(-1.000000, -1.000000, 0.000000, 0.000000)
max r0.w, cb12[0].z, l(0.001000)
mul r2.xy, r0.wwww, r1.xyxx
dp2 r0.w, r1.xyxx, r1.xyxx
add r0.w, -r0.w, l(1.000000)
sqrt r0.w, |r0.w|
mul r1.xyw, r2.yyyy, v6.xyxz
mad r1.xyw, r2.xxxx, v5.xyxz, r1.xyxw
mad r1.xyw, r0.wwww, v3.xyxz, r1.xyxw
dp3 r0.w, r1.xywx, r1.xywx
rsq r0.w, r0.w
mad r2.x, r1.w, r0.w, l(-0.350000)
mul r1.xyw, r0.wwww, r1.xyxw
mad o1.xyz, r1.xywx, l(0.500000, 0.500000, 0.500000, 0.000000), l(0.500000, 0.500000, 0.500000, 0.000000)
mul_sat r0.w, r2.x, l(1.538462)
...
dp3 r0.x, r0.xyzx, l(1.275000, 4.292400, 0.432600, 0.000000)
add r0.x, -r0.x, l(0.500000)
add_sat o2.w, -r0.x, v3.w
mov o0.w, cb2[11].x
dp3 r0.x, v3.xyzx, v3.xyzx
rsq r0.x, r0.x
mul r0.x, r0.x, v3.z
mad_sat r0.x, r0.x, l(128.000000), l(-127.000000)
mul o1.w, r1.z, r0.x
mov r0.x, -r1.x
mul r0.z, cb12[0].x, l(0.001953)
mov r0.y, -r0.z
add r0.xy, r0.xyxx, l(0.500000, 0.488281, 0.000000, 0.000000)
max r0.xy, r0.xyxx, l(0.000000, 0.000000, 0.000000, 0.000000)
mad r1.x, r0.x, r0.w, r1.x
mad r1.y, r0.y, r0.w, r0.z
sqrt o2.xy, r1.xyxx
mov o2.z, l(0.980000)
