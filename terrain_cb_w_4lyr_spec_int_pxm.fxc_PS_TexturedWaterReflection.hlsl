...
add r1.y, v3.z, cb3[43].w
mul r1.y, r1.y, cb3[44].w
max r1.y, r1.y, l(0.000000)
mad r2.xyz, cb3[45].xyzx, r1.yyyy, cb3[46].xyzx
mul r2.xyz, r2.xyzx, cb2[12].zzzz
mad r3.xyz, cb3[47].xyzx, r1.yyyy, cb3[48].xyzx
...
mov r4.y, cb3[47].w
mov r4.z, cb3[48].w
dp3_sat r1.x, r4.xyzx, v3.xyzx
mad r1.xyz, cb3[49].xyzx, r1.xxxx, r1.yzwy
mad r1.xyz, r1.xyzx, r3.xxxx, r2.xyzx
sample r2.xyzw, v0.xyxx, t2.xyzw, s2
sample r3.xyzw, v0.xyxx, t5.xyzw, s5
mov_sat r4.xyz, v1.xyzx
...
mad r0.xyw, -r1.xyxz, r2.xyxz, r0.xyxw
