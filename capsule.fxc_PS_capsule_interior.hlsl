...
// gbufferStencilTextureGlobal       texture   uint2          2d            t11      1 
...
dp3 r0.z, r3.xyzx, cb12[1].xyzx
div_sat r0.z, r0.z, cb12[5].x
mul r0.z, r0.z, cb12[5].x
mad r3.xyz, cb12[1].xyzx, r0.zzzz, cb12[0].xyzx
add r3.xyz, -r2.xyzx, r3.xyzx
dp3 r0.z, r3.xyzx, r3.xyzx
mad_sat r0.w, -r0.z, cb12[4].z, l(1.000000)
add r1.w, -cb12[7].x, l(1.000000)
mad r1.w, r1.w, r0.w, cb12[7].x
div r0.w, r0.w, r1.w
mov r2.w, l(1.000000)
...
discard_nz r1.w
mul r2.xy, r0.xyxx, cb2[14].xyxx
ftoi r2.xy, r2.xyxx
mov r2.zw, l(0,0,0,0)
ld r2.xyzw, r2.xyzw, t11.xyzw
and r1.w, r2.y, l(8)
utof r1.w, r1.w
ge r1.w, r1.w, l(8.000000)
and r1.w, r1.w, l(0x3f800000)
