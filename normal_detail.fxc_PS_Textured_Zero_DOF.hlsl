...
max r4.w, |r9.y|, |r9.x|
lt r4.w, r4.w, r3.y
movc r3.z, r4.w, l(1), r3.z
max r4.w, |r8.y|, |r8.x|
lt r3.y, r4.w, r3.y
movc r3.y, r3.y, l(0), r3.z
mov r8.xyz, x0[r3.y + 0].xyzx
itof r3.y, r3.y
add r3.z, r3.y, l(0.500000)
mul r3.z, r3.z, l(0.250000)
eq r9.xyzw, l(0.000000, 1.000000, 2.000000, 3.000000), r3.yyyy
and r9.xyzw, r9.xyzw, l(0x3f800000, 0x3f800000, 0x3f800000, 0x3f800000)
dp4 r3.y, r9.xyzw, cb6[12].xyzw
...
deriv_rtx r10.z, r3.y
deriv_rty r12.xyz, r9.yxyy
deriv_rty r12.w, r3.y
...
mad r3.y, -r4.w, r7.z, r3.y
mad r3.y, -r4.w, r7.w, r3.y
movc r11.z, r3.z, r3.y, r8.z
mov r9.z, l(0)
...
dp4 r3.y, r8.xyzw, l(1.000000, 1.000000, 1.000000, 1.000000)
mad_sat r3.x, r3.x, cb6[0].w, cb6[1].w
max r3.z, |r7.y|, |r7.x|
mad_sat r3.z, r3.z, l(15.000000), l(-6.300000)
add r3.x, -r3.x, l(1.000000)
mul r3.x, r3.z, r3.x
mad r3.x, r3.y, l(0.062500), r3.x
mul r3.x, r3.x, r3.x
min r3.x, r3.x, l(1.000000)
mad_sat r3.y, v5.z, cb6[3].x, cb6[3].y
sqrt r3.y, r3.y
mul r3.y, r3.y, cb6[3].z
mad r3.x, r3.y, -r3.x, r3.x
dp3_sat r3.y, r2.yzwy, -cb3[0].xyzx
dp3_sat r4.x, r4.xyzx, r2.yzwy
...
add r3.z, -cb12[0].x, l(1.000000)
mad r4.xy, cb12[0].xxxx, r4.xyxx, r3.zzzz
add r3.zw, r3.wwww, l(0.000000, 0.000000, 2.000000, 0.000000)
mul r3.z, r3.z, l(0.125000)
mad r4.x, -r1.x, r4.x, l(1.000000)
dp3 r4.z, r2.yzwy, r5.xyzx
...
mad r1.xyz, r1.xzwx, r1.yyyy, r4.yzwy
