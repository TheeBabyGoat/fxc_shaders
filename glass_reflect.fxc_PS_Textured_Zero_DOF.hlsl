...
//   float reflectivePower;             // Offset:   12 Size:     4
...
dp3 r2.w, -r2.xyzx, r1.yzwy
add r2.w, r2.w, r2.w
mad r2.xyz, r1.yzwy, -r2.wwww, -r2.xyzx
dp3 r2.y, r2.xyzx, r2.xyzx
rsq r2.y, r2.y
mad r2.xy, r2.xzxx, r2.yyyy, l(1.000000, 1.000000, 0.000000, 0.000000)
mul r2.xy, r2.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
sample r2.xyzw, r2.xyxx, t2.xyzw, s2
mul r2.xyz, r2.xyzx, cb12[0].wwww
mul r0.w, r0.w, v0.w
...
add r5.zw, r3.zzzz, l(0.000000, 0.000000, 2.000000, 0.000000)
mul r5.z, r5.z, l(0.125000)
mad r5.x, -r2.w, r5.x, l(1.000000)
...
mul r2.w, r4.w, r2.w
mul r4.w, r4.w, r5.x
mad r5.yzw, r0.xxyz, r4.wwww, r2.wwww
...
mad r1.xyz, r1.xyzx, r3.xxxx, r6.xyzx
